...
tpm_dir = ['../../tpms/' num2str(nChannels) 'ch_diff_perSong_3t1_GP7Left/'];
phi_dir = ['../' num2str(nChannels) 'ch_diff_perSong_3t1_GP7Left/'];

out_file = [num2str(nChannels) 'ch_diff_perSong_phi3_3t1_GP7Left.mat'];
